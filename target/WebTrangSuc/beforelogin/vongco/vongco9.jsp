...
<section class="section main">
    <div class="container">
        <div class="content">
            <img src="<%= request.getContextPath() %>/static/img/Home/vongco6.jpg" alt="#" class="img-prd"/>
        </div>

        <div class="sidebar">
            <div class="title">
                <h1 class="content-product-h3">Superior Buffalo Horn Necklace - JN583</h1>
            </div>
