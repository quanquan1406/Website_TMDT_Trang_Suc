...
<section class="section main">
    <div class="container">
        <div class="content">
            <img src="<%= request.getContextPath() %>/static/img/Home/vongco5.jpg" alt="#" class="img-prd"/>
        </div>

        <div class="sidebar">
            <div class="title">
                <h1 class="content-product-h3">New Necklace With New Work - JN008</h1>
            </div>
